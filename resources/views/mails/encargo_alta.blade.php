    ...
    <div class="row row-app">
        <div class="col-md-12">
            <div class="col-separator col-unscrollable col-separator-first">
                <div class="col-table">
                    <h4 class="innerAll">Alta de encargo</h4>
                            ...
                            <div class="col-app">
                                <div class="innerAll">
                                    <div class="box-generic animated">
                                        ...
                                        <p>
                                            Con fundamento en lo dispuesto en los <strong class="text-primary">Artículos 76, 77 y 78 de la Ley de Responsabilidades de los servidores Públicos en el Estado de Chiapas vigente</strong>, le comunicamos que debe realizar sus declaraciones de situación patrimonial ante el Centro Estatal de Control de Confianza Certificado a través del sistema web <strong class="text-primary">SIDEP (Sistema Integral de Declaraciones Patrimoniales C3)</strong>.
                                        </p>
                                        <p>
                                        ...
                                        <p>Así mismo, le enviamos como archivos adjuntos su carta compromiso y su comprobante de usuario y contraseña, en donde encontrará los datos para acceder al portal del sistema antes mencionado</p>
