    ...
    <div class="row row-app">
        <div class="col-md-12">
            <div class="col-separator box col-separator-first col-unscrollable">
                <div class="col-table">
                    <h3 class="innerAll">REPORTE DE DECLARACIONES REALIZADAS</h3>
                                ...
                                <div class="row row-app">
                                    <div class="col-md-3">
                                        <div class="col-separator">
                                            ...
                                            <form role="form" action="{{ route('declaraciones-realizadas-exportar') }}" id="formFiltro" method="post">
                                                {!! csrf_field() !!}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input class="form-control fecha required" type="text" name="fecha2" id="fecha2" value="" readonly>
                                                                    <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="text-center border-top innerTB">
                                                    <button id="buscar" type="button" class="btn btn-primary" data-url="{{ route('declaraciones-realizadas-buscar') }}"><i class="fa fa-search"></i> Buscar</button>
...
@section('js')
    <script src="{{ asset('public/js/consultas/declaraciones_realizadas.js') }}"></script>
@stop