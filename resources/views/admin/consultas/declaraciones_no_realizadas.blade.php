    ...
    <div class="row row-app">
        <div class="col-md-12">
            <div class="col-separator box col-separator-first col-unscrollable">
                <div class="col-table">
                    <h3 class="innerAll">REPORTE DE DECLARACIONES NO REALIZADAS</h3>
                                ...
                                <div class="row row-app">
                                    <div class="col-md-3">
                                        <div class="col-separator">
                                            ...
                                            <form role="form" action="{{ route('declaraciones-no-realizadas-exportar') }}" id="formFiltro" method="post">
                                                {!! csrf_field() !!}
                                                ...
                                                <div class="text-center border-top innerTB">
                                                    <button id="buscar" type="button" class="btn btn-primary" data-url="{{ route('declaraciones-no-realizadas-buscar') }}"><i class="fa fa-search"></i> Buscar</button>
...
@section('js')
    <script src="{{ asset('public/js/consultas/declaraciones_no_realizadas.js') }}"></script>
@stop