    ...
    <div style="max-height: 500px; overflow-y: auto" id="tabla">
        <table id="tablaResultados" class="table table-bordered text-small">
            ...
            <tr>
                ...
                <th>FECHA RETORNO REQUERIMIENTO</th>
                <th>&nbsp;</th>
            </tr>
            </thead>
            <tbody>
            @foreach($declaraciones as $declaracion)
                <tr>
                    ...
                    <td>{{ $declaracion->getFechaRecepcionRequerimiento() }}</td>
                    <td><button type="button" class="btn btn-info btn-xs desmarcar" data-id="{{ base64_encode($declaracion->getId()) }}" data-toggle="tooltip" data-original-title="DESMARCAR RECEPCIÓN REQUERIMIENTO" data-placement="left"><i class="fa fa-undo"></i></button></td>
                </tr>
            @endforeach
            </tbody>
        </table>
