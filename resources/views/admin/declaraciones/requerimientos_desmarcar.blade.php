    ...
    <div class="row row-app">
        <div class="col-md-12">
            <div class="col-separator box col-separator-first col-unscrollable">
                <div class="col-table">
                    <h3 class="innerAll">DESMARCAR RETORNO DE REQUERIMIENTOS</h3>
                                        ...
                                        <div class="col-separator">
                                            ...
                                            <form role="form" action="" id="formFiltro" method="post">
                                                ...
                                                <div class="text-center border-top innerTB">
                                                    <button id="buscar" type="button" class="btn btn-primary" data-url="{{ route('requerimientos-desmarcar-buscar') }}"><i class="fa fa-search"></i> BUSCAR</button>
                                                </div>
                                            </form>
                                            <div class="col-separator-h"></div>
                                        </div>
                                        ...
                                        <div class="col-separator col-separator-last">
                                            <div class="col-table">
                                                ...
                                                <div class="col-table-row">
                                                    <div class="col-app col-unscrollable">
                                                        <div class="col-app">
                                                            <div class="innerAll" id="resultadoBusqueda" data-url="{{ route('requerimientos-desmarcar') }}"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@section('js')
    <script src="{{ asset('public/js/declaraciones/requerimientos_desmarcar.js') }}"></script>
@stop