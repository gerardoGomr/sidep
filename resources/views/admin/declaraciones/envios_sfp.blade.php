    ...
    <div class="row row-app">
        <div class="col-md-12">
            <div class="col-separator box col-separator-first col-unscrollable">
                <div class="col-table">
                    <h3 class="innerAll">DECLARACIONES A ENVIAR A SECRETARÍA DE LA FUNCIÓN PÚBLICA</h3>
                                ...
                                <div class="row row-app">
                                        ...
                                        <div class="col-separator">
                                            ...
                                            <form role="form" action="" id="formFiltro" method="post">
                                                ...
                                                <div class="text-center border-top innerTB">
                                                    <button id="buscar" type="button" class="btn btn-primary" data-url="{{ route('envios-sfp-marcar-buscar') }}"><i class="fa fa-search"></i> BUSCAR</button>
                                                </div>
                                            </form>
                                            <div class="col-separator-h"></div>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="col-separator col-separator-last">
                                            <div class="col-table">
                                                <h4 class="innerAll bg-gray border-bottom margin-bottom-none">PENDIENTES DE MARCAR</h4>
                                                <div class="col-table-row">
                                                    <div class="col-app col-unscrollable">
                                                        <div class="col-app">
                                                            <div class="innerAll" id="resultadoBusqueda" data-url="{{ route('requerimiento-eliminar') }}" data-url-desmarcar="{{ route('requerimientos-desmarcar') }}">
                                                                @include('admin.declaraciones.envios_sfp_resultados')
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('js')
    <script src="{{ asset('public/js/declaraciones/envios_sfp.js') }}"></script>
@stop