...
@section('contenido')
    ...
    @include('admin.servidores_publicos.servidores_publicos_baja')
    @include('admin.servidores_publicos.servidores_publicos_cambio_adscripcion')
    @include('admin.servidores_publicos.servidores_publicos_promocion')
