 ...
 */
class CuentaAcceso extends \Sidep\Dominio\ServidoresPublicos\CuentaAcceso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CuentaAcceso $proxy) {
    ...
    public function generarCuentaDeAcceso($rfc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'generarCuentaDeAcceso', [$rfc]);

        return parent::generarCuentaDeAcceso($rfc);
    }
